            ...
            <tbody>
                <?php if($recent_tasks): ?>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-<?php echo ($task['status']==='Terminée'?'success':($task['status']==='En attente'?'warning text-dark':($task['status']==='En cours'?'info':($task['status']==='À faire'?'secondary':'light')))); ?>"><?php echo htmlspecialchars($task['status']); ?></span></td>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="task_edit.php?id=<?php echo $task['id']; ?>" class="btn btn-sm btn-outline-primary rounded-pill fw-semibold" title="Consulter la tâche">
